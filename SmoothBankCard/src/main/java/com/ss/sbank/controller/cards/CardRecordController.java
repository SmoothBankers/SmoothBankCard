...
public class CardRecordController {
	...
	public ResponseEntity<CardRecord> updateRecord(@RequestBody Map<String, Object> payload) {
		...
		/**
		 * { "holder": { "id": 1, "holderName": "Parker Williams", "homePhone":
		 * "1234567890", "workPhone": "0918736452", "email":
		 * "parker.williams@smoothstack.com", "ssn": "123456789", "address": "address",
		 * "po_box": null, "zipcode": 56709, "monthlyIncome": 750 }, "card": { "id":
		 * 43210006187739310, "csv": 368, "expiryMonth": 11, "expiryYear": 2023,
		 * "balance": null, "cashback": null, "type": { "id": 2, "title": "Promo credit
		 * card", "description": "A promotional credit card available to accounts within
		 * 6 months of creation.", "rate": 0.05 }, "holderName": "Parker Williams" },
		 * "active": 0, "id": 2, "signUpDate": "2021-06-27" }
		 */
